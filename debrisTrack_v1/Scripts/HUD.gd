...
@onready var SimulationDAte : Label = $TopBar/VBoxContainer/TopContainer/BarraSuperior/VBoxContainer/HBoxContainer/Date/SimulationDate
...
#region Fecha y Hora
	...
	Date.text = Date.text + " " + str(HoraConvert) + ":" + str(hora["minute"]) + ":" + str(hora["second"]) + AmPm
